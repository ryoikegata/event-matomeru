        ...
        <div className="flex flex-col items-center gap-4 pt-4">
          <div className="">
            ...
            <input
              ...
              className="border p-1 rounded w-300"
            />
          </div>
          <div className="">
            <h2 className="font-bold">
          ...
          <div className="">
            ...
            <textarea
              ...
              className="border p-1 rounded w-300 resize-none"
              rows={7}
            ></textarea>
          </div>
          <button className="text-white bg-blue-500 rounded-full w-72 text-lg font-bold py-2">
            作成
          </button>
        </div>
      </main>
